...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2024/10/16 22:41:59 by rlibran-          #+#    #+#             */
/*   Updated: 2024/10/16 22:41:59 by rlibran-         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
// chat used: https://chatgpt.com/share/67103594-8fd8-800c-8fc6-873b426c2287
#include <stdio.h>
#include <string.h>
#include <fcntl.h>
#include <unistd.h>
...
void	simple_putstr_fd(char *s, int fd);
...
void	test_case1()
{
	...
	ft_putstr_fd(test_string, fd1);
	simple_putstr_fd(test_string, fd2);
...
void	test_case6()
{
	...
	ft_putstr_fd(test_string, -1);
	simple_putstr_fd(test_string, -1);
